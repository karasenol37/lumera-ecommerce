...
export default function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!form.email || !form.password) {
      setErrorMsg("Lütfen e-posta adresinizi ve şifrenizi giriniz.");
      return;
    }
    ...
    try {
      ...
      if (!result.success) {
        setErrorMsg(result.message || "E-posta adresi veya şifre hatalı.");
        setLoading(false);
        return;
      }
      ...
      console.error(err);
      setErrorMsg("Giriş yapılırken bir sunucu hatası oluştu.");
      setLoading(false);
    }
  }
