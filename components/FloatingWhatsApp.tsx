...
export default function FloatingWhatsApp() {
  ...
  return (
    <aside aria-label="WhatsApp İletişim Hattı" className="fixed bottom-20 md:bottom-8 right-4 md:right-8 z-40">
      <a
        href={whatsappUrl}
        target="_blank"
        rel="noopener noreferrer"
        className="group relative flex items-center gap-3 rounded-full bg-[#25D366] p-3.5 md:px-5 md:py-3.5 text-white shadow-[0_8px_30px_rgba(37,211,102,0.4)] transition-all duration-300 hover:scale-105 hover:bg-[#20bd5a] hover:shadow-[0_12px_40px_rgba(37,211,102,0.6)]"
      >
        {/* Pulse effect */}
